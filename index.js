...
function serve(port, pathToSpec, options) {
  ...
  return __awaiter(this, void 0, void 0, function () {
    var spec, pageHTML, server, pathToSpecDirectory_1, watchOptions, watcher, log_1;
    var _this = this;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
        ...
        case 2:
          ...
          server.listen(port, function () {
            return console.log("Server started: http://127.0.0.1:" + port);
          });
          if (options.watch && fs_1.existsSync(pathToSpec)) {
            ...
            watcher
              ...
              .on('error', function (error) {
                return console.error("Watcher error: " + error);
              })
              .on('ready', function () {
                return log_1("\uD83D\uDC40  Watching " + pathToSpecDirectory_1 + " for changes...");
              });
          }
          return [2 /*return*/ ];
      }
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          spec = _a.sent();
          return [4 /*yield*/ , getPageHTML(spec, pathToSpec, __assign({}, options, {
            ssr: true
          }))];
        case 2:
          pageHTML = _a.sent();
...
function getPageHTML(spec, pathToSpec, _a) {
  var ssr = _a.ssr,
    cdn = _a.cdn,
    title = _a.title,
    templateFileName = _a.templateFileName,
    _b = _a.redocOptions,
    redocOptions = _b === void 0 ? {} : _b;
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 1:
          ...
          html = server_1.renderToString(sheet.collectStyles(React.createElement(redoc_1.Redoc, {
            store: store
          })));
...
function respondWithGzip(contents, request, response, headers) {
  ...
  if (acceptEncoding.match(/\bdeflate\b/)) {
    response.writeHead(200, __assign({}, headers, {
